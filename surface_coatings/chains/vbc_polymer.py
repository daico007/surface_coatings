...
from surface_coatings.monomers import (
    SBMA,
    VBC,
    AzPMA,
    Methacrylate,
...
class VBCPolymer(mb.Compound):
    """A general method to create a Vinylbenzyl Polymer.
    ...
    def __init__(
        self,
        monomers=[Methacrylate(), SBMA(), AzPMA(), TriazoleBiotin()],
        n=1,
        sequence="AABCBBD",
        port_labels=("up", "down"),
    ):
        ...
        mb.force_overlap(vbc, vbc["up"], polymer[port_labels[0]])
