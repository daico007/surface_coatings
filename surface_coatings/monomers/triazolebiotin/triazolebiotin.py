...
class TriazoleBiotin(mb.Compound):
    ...
    front_cap : bool, optional, default=False
        Add hydrogen cap to the front end of the TriazoleBiotin. To be implemented.
    rear_cap : bool, optional, default=False
        Add hydrogen cap to the rear end of the TriazoleBiotin. To be implemented.
    """
    ...
    def __init__(self, front_cap=False, rear_cap=False):
        ...
        self.add(
            mb.Port(anchor=self[0], orientation=bond_vect, separation=-0.07),
            "down",
        )
        self.add(
